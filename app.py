...
if city_data:
    ...
    # ── City Cards ─────────────────────────────────────────────────────────────
    # Two rows of 5 cards, matching second image style:
    # White card, left colored accent bar, city name uppercase, big colored number,
    # "PM2.5 ug/m3" label, outlined category badge at bottom.
